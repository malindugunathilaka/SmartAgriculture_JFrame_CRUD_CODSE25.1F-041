...
public class Farmer {
    ...
    public Farmer(String farmerName, String nic, String address, String contactNo) {
        this.farmerName = farmerName; this.nic = nic; this.address = address; this.contactNo = contactNo;
    }
    public Farmer(int farmerId, String farmerName, String nic, String address, String contactNo, Timestamp createdAt) {
        this.farmerId = farmerId; this.farmerName = farmerName; this.nic = nic;
        this.address = address; this.contactNo = contactNo; this.createdAt = createdAt;
    }
